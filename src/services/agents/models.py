...
class SourceItem(BaseModel):
    ...
    :param arxiv_id: Legacy arXiv paper ID (optional)
    :param source_type: Source type (project/external_web/legacy_arxiv)
    :param title: Document title
    :param authors: List of authors
    :param url: Source URL
    :param doc_name: Source document name (if available)
    :param page_number: Source page number (if available)
    :param relevance_score: Relevance score from retrieval
    """

    arxiv_id: Optional[str] = Field(default=None, description="Legacy arXiv paper ID")
    source_type: str = Field(default="project", description="Source type")
    title: str = Field(default="", description="Document title")
    authors: List[str] = Field(default_factory=list, description="List of authors")
    url: str = Field(default="", description="Link to source")
    ...
    excerpt: Optional[str] = Field(default=None, description="Grounding excerpt")
